...
export class YoyakuAdapter extends RecordStoreAdapter {
  ...
  async checkAvailability(release) {
    ...
    return {
      available: true,
      url: `https://example-store.com/?s=${encodeURIComponent(q)}&post_type=product`,
      price: null,
    }
  }
